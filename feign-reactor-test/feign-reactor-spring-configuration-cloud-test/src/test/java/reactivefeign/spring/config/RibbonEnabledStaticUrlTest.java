...
import static reactivefeign.spring.config.RibbonEnabledHystrixDisabledUsingPropertiesTest.FEIGN_CLIENT_TEST_RIBBON;
...
public class RibbonEnabledStaticUrlTest {
	...
	@ReactiveFeignClient(name = FEIGN_CLIENT_TEST_RIBBON, url = "localhost:"+MOCK_SERVER_PORT)
	...
	@EnableReactiveFeignClients(clients = RibbonEnabledStaticUrlTest.TestReactiveFeignClient.class)
